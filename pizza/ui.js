...
export function renderFooter() {
  ...
  <footer class="footer">
    <div class="row">
      <div style="max-width: 320px;">
        ...
        <p style="font-size:14px;color:var(--musgo);line-height:1.6;margin:12px 0 0;">
          ${esc(CONTATO.endereco)}<br>${esc(CONTATO.telefone)}
        </p>
      </div>
    ...
    <p class="note">Todas as fotos de pizza são <strong>meramente ilustrativas</strong>. Pagamentos processados via Asaas.</p>
  </footer>`;
}

export function renderWhatsApp() {
  const numero = (typeof window !== 'undefined' && window.APP_WHATSAPP) || '5531996678280';
